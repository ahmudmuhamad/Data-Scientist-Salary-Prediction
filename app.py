...
job_simp = st.selectbox("Job Simplification", options=df['job_simp'].value_counts().index)  # Modify as needed
age_of_company = st.number_input("Age of Company (Years)", min_value=-1)
num_competitors = st.number_input("Number of Competitors", min_value=)
